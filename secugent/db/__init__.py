...
"""Data-plane store-selection seam.
...
The seam, the synchronous bridge over the async PG store, the migration, and
the single-writer fence are all unit-tested against SQLite + fakes; the *live
request-path swap* onto PG requires a real Postgres (staged) and is documented,
